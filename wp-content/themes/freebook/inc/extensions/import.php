...
add_action( 'cherry_data_import_home_regex_replace', 'freebook_remap_shortcodes' );
add_action( 'cherry_data_import_remap_posts',        'freebook_remap_menus' );
add_action( 'cherry_data_import_remap_posts',        'freebook_remap_timetable' );
 ...
 * @return array
 */
function freebook_remap_shortcodes( $regex ) {
 ...
 */
function freebook_remap_timetable( $posts ) {
 ...
 * @param array $posts post remapping array.
 */
function freebook_remap_menus( $posts ) {
