...
if ( ! class_exists( 'FreeBook_Widget_Area' ) ) {

	/**
	 * Class FreeBook_Widget_Area.
	 */
	class FreeBook_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'freebook_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'freebook_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'freebook_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function freebook_widget_area() {
		return FreeBook_Widget_Area::get_instance();
	}

	freebook_widget_area();
}
