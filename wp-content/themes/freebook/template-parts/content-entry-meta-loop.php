...
<?php if ( 'post' === get_post_type() ) : ?>
	...
	<div class="entry-meta">
		...
		<?php $date_visible = freebook_is_meta_visible( 'blog_post_publish_date', 'loop' );
		...
		<?php $author_visible = freebook_is_meta_visible( 'blog_post_author', 'loop' );
		...
		<?php $comment_visible = freebook_is_meta_visible( 'blog_post_comments', 'loop' );
		...
		<?php $cats_visible = freebook_is_meta_visible( 'blog_post_categories', 'loop' );
		...
		<?php $tags_visible = freebook_is_meta_visible( 'blog_post_tags', 'loop' );
