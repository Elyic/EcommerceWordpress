...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'posts-list__item card' ); ?>>
	...
	$size                = freebook_post_thumbnail_size( array( 'class_prefix' => 'post-thumbnail--' ) );
	?>
	...
	<div class="post-list__item-content">
		...
		<div class="entry-content">
			<?php $blog_content = get_theme_mod( 'blog_posts_content', freebook_theme()->customizer->get_default( 'blog_posts_content' ) );
