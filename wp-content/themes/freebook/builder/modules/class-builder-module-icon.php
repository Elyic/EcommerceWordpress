 ...
 */
class FreeBook_Builder_Module_Icon extends Tm_Builder_Module {

	public $function_name;

	public function init() {
		$this->name = esc_html__( 'Icon', 'freebook' );
		$this->icon = 'f1d8';
	...
	public function get_fields() {
		...
		$fields = array(
			'font_icon' => array(
				'label'               => esc_html__( 'Icon', 'freebook' ),
				'type'                => 'text',
				'option_category'     => 'basic_option',
				'class'               => array( 'tm-pb-font-icon' ),
				'renderer'            => 'tm_pb_get_font_icon_list',
				'renderer_with_field' => true,
				'description'         => esc_html__( 'Choose an icon to display.', 'freebook' ),
			),
			'icon_color' => array(
				'label'       => esc_html__( 'Icon Color', 'freebook' ),
				'type'        => 'color-alpha',
				'description' => esc_html__( 'Here you can define a custom color for your icon.', 'freebook' ),
			),
			'use_circle' => array(
				'label'           => esc_html__( 'Circle Icon', 'freebook' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'options'         => array(
					'off' => esc_html__( 'No', 'freebook' ),
					'on'  => esc_html__( 'Yes', 'freebook' ),
				),
				'affects'         => array(
				...
				'description'     => esc_html__( 'Here you can choose whether icon set above should display within a circle.', 'freebook' ),
			),
			'circle_color' => array(
				'label'       => esc_html__( 'Circle Color', 'freebook' ),
				'type'        => 'color-alpha',
				'description' => esc_html__( 'Here you can define a custom color for the icon circle.', 'freebook' ),
			),
			'use_circle_border' => array(
				'label'           => esc_html__( 'Show Circle Border', 'freebook' ),
				'type'            => 'yes_no_button',
				...
				'description'     => esc_html__( 'Here you can choose whether if the icon circle border should display.', 'freebook' ),
			),
			'circle_border_color' => array(
				'label'       => esc_html__( 'Circle Border Color', 'freebook' ),
				'type'        => 'color-alpha',
				'description' => esc_html__( 'Here you can define a custom color for the icon circle border.', 'freebook' ),
			),
			'animation' => array(
				'label'           => esc_html__( 'Icon Animation', 'freebook' ),
				'type'            => 'select',
				'option_category' => 'configuration',
				'options'         => array(
					'top'    => esc_html__( 'Top To Bottom', 'freebook' ),
					'left'   => esc_html__( 'Left To Right', 'freebook' ),
					'right'  => esc_html__( 'Right To Left', 'freebook' ),
					'bottom' => esc_html__( 'Bottom To Top', 'freebook' ),
					'off'    => esc_html__( 'No Animation', 'freebook' ),
				),
				'description'     => esc_html__( 'This controls the direction of the lazy-loading animation.', 'freebook' ),
			),
			'icon_orientation' => array(
				'label'           => esc_html__( 'Icon Orientation', 'freebook' ),
				'type'            => 'select',
				'option_category' => 'layout',
				'options'         => array(
				...
				'description'     => esc_html__( 'This will control how your icon is aligned.', 'freebook' ),
			),
			'use_icon_font_size' => array(
				'label'           => esc_html__( 'Use Icon Font Size', 'freebook' ),
				'type'            => 'yes_no_button',
			...
			'icon_font_size' => array(
				'label'           => esc_html__( 'Icon Font Size', 'freebook' ),
				'type'            => 'range',
				'option_category' => 'font_option',
				'tab_slug'        => 'advanced',
				'default'         => '50px',
			...
			'circle_size' => array(
				'label'           => esc_html__( 'Circle Size', 'freebook' ),
				'type'            => 'range',
				'option_category' => 'layout',
				'tab_slug'        => 'advanced',
				'default'         => '100',
				...
				'description'     => esc_html__( 'Here you can define a custom diameter for the icon circle.', 'freebook' ),
				'mobile_options'  => true,
				'depends_default' => true,
			),
			'circle_border_width' => array(
				'label'           => esc_html__( 'Circle Border Width', 'freebook' ),
				'type'            => 'range',
				'option_category' => 'layout',
				'tab_slug'        => 'advanced',
				'default'         => '2',
				...
				'description'     => esc_html__( 'Here you can define a custom width for the icon circle border.', 'freebook' ),
				'depends_default' => true,
			),
			...
			'disabled_on' => array(
				'label'           => esc_html__( 'Disable on', 'freebook' ),
				'type'            => 'multiple_checkboxes',
				'options'         => tm_pb_media_breakpoints(),
				'additional_att'  => 'disable_on',
				'option_category' => 'configuration',
				'description'     => esc_html__( 'This will disable the module on selected devices', 'freebook' ),
			),
			'admin_label' => array(
				'label'       => esc_html__( 'Admin Label', 'freebook' ),
				'type'        => 'text',
				'description' => esc_html__( 'This will change the label of the module in the builder for easy identification.', 'freebook' ),
			),
			'module_id' => array(
				'label'           => esc_html__( 'CSS ID', 'freebook' ),
				'type'            => 'text',
				'option_category' => 'configuration',
				'tab_slug'        => 'custom_css',
			...
			'module_class' => array(
				'label'           => esc_html__( 'CSS Class', 'freebook' ),
				'type'            => 'text',
				'option_category' => 'configuration',
				'tab_slug'        => 'custom_css',
				'option_class'    => 'tm_pb_custom_css_regular',
...
new FreeBook_Builder_Module_Icon;
