...
/**
 * Class FreeBook_Builder_Module_Countdown_Timer.
 */
class FreeBook_Builder_Module_Countdown_Timer extends Tm_Builder_Module {

	public $function_name;

	public function init() {
		$this->name = esc_html__( 'Countdown Timer', 'freebook' );
		...
		$this->advanced_options = array(
			'fonts' => array(
				'header' => array(
					'label'    => esc_html__( 'Header', 'freebook' ),
					'css'      => array(
						'main' => "{$this->main_css_element} h4",
					),
				),
				'numbers' => array(
					'label'    => esc_html__( 'Numbers', 'freebook' ),
					'css'      => array(
				...
				'label' => array(
					'label'    => esc_html__( 'Label', 'freebook' ),
					'css'      => array(
		...
		$this->custom_css_options = array(
			'container' => array(
				'label'    => esc_html__( 'Container', 'freebook' ),
			...
			'timer_section' => array(
				'label'    => esc_html__( 'Timer Section', 'freebook' ),
				'selector' => '.section',
			),
		);
	}
	...
	public function get_fields() {
		$fields = array(
			'title' => array(
				'label'           => esc_html__( 'Countdown Timer Title', 'freebook' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'This is the title displayed for the countdown timer.', 'freebook' ),
			),
			'date_time' => array(
				'label'           => esc_html__( 'Countdown To', 'freebook' ),
				'type'            => 'date_picker',
				'option_category' => 'basic_option',
				'description'     => tm_get_safe_localization(
					sprintf(
						...
						esc_html__( 'This is the date the countdown timer is counting down to. Your countdown timer is based on your timezone settings in your ', 'freebook' ),
						esc_html__( 'WordPress General Settings', 'freebook' )
					)
				),
			),
			'use_background_color' => array(
				'label'           => esc_html__( 'Use Background Color', 'freebook' ),
				'type'            => 'yes_no_button',
				...
				'description' => esc_html__( 'Here you can choose whether background color setting below should be used or not.', 'freebook' ),
			),
			'background_color' => array(
				'label'             => esc_html__( 'Background Color', 'freebook' ),
				'type'              => 'color-alpha',
				'depends_default'   => true,
				'description'       => esc_html__( 'Here you can define a custom background color for your countdown timer.', 'freebook' ),
			),
			'timer_layout' => array(
				'label'             => esc_html__( 'Layout', 'freebook' ),
				'type'              => 'select',
				'options'           => array(
					'flat'   => esc_html__( 'Flat', 'freebook' ),
					'circle' => esc_html__( 'Circle', 'freebook' ),
				),
				'affects'           => array(
			...
			'circle_background' => array(
				'label'               => esc_html__( 'Circle Background Color', 'freebook' ),
				'type'                => 'color-alpha',
			...
			'use_circle_border' => array(
				'label'           => esc_html__( 'Use Circle Border', 'freebook' ),
				'type'            => 'yes_no_button',
...
new FreeBook_Builder_Module_Countdown_Timer;
