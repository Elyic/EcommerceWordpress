<?php
/**
 * Class FreeBook_Builder_Module_Number_Counter.
 */
class FreeBook_Builder_Module_Number_Counter extends Tm_Builder_Module {

	public $function_name;

	public function init() {
		$this->name = esc_html__( 'Number Counter', 'freebook' );
		...
		$this->custom_css_options = array(
			'percent' => array(
				'label'    => esc_html__( 'Percent', 'freebook' ),
				'selector' => '.percent',
			),
			'number_counter_title' => array(
				'label'    => esc_html__( 'Number Counter Title', 'freebook' ),
				'selector' => 'h3',
			),
		);
		...
		$this->advanced_options = array(
			'fonts' => array(
				...
				'number'   => array(
					'label'    => esc_html__( 'Number', 'freebook' ),
					'css'      => array(
	...
	public function get_fields() {
		$fields = array(
			'title' => array(
				...
				'description'     => esc_html__( 'Input a title for the counter.', 'freebook' ),
			),
			'number' => array(
				'label'           => esc_html__( 'Number', 'freebook' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( "Define a number for the counter. (Don't include the percentage sign, use the option below.)", 'freebook' ),
			),
			'percent_sign' => array(
				'label'           => esc_html__( 'Percent Sign', 'freebook' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'options'         => array(
					'on'  => esc_html__( 'On', 'freebook' ),
					'off' => esc_html__( 'Off', 'freebook' ),
				),
				'description'     => esc_html__( 'Here you can choose whether the percent sign should be added after the number set above.', 'freebook' ),
			),
			'counter_color' => array(
				'label'       => esc_html__( 'Counter Text Color', 'freebook' ),
				'type'        => 'color',
				'description' => esc_html__( 'This will change the fill color for the bar.', 'freebook' ),
			),
			'use_icon' => array(
				'label'           => esc_html__( 'Use Icon', 'freebook' ),
				'type'            => 'yes_no_button',
				'option_category' => 'basic_option',
				'options'         => array(
				...
				'description'     => esc_html__( 'Here you can choose whether icon set below should be used.', 'freebook' ),
			),
			'font_icon' => array(
...
new FreeBook_Builder_Module_Number_Counter;
